...
if ($_SESSION['hakakses'] != "user") {
    ...
    if (!$result) {
        ...
        if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='editcustomers.php';</script>";
              }
            } else {
                 echo "<script>alert('Masukkan data id.');window.location='editcustomers.php';</script>";
                }
?>
   ...
   <div class="overlay"></div>
       ...
       <div class="container-fluid p-0 px-lg-0 px-md-0">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <form action="../proses/proseseditsuppliers.php" method="POST" enctype="multipart/form-data" >
            <input name="id" value="<?php echo $data['id']; ?>" hidden />
                <div class="form-group">
                    <label for="usr">Nama Toko:</label>
                    <input type="text" class="form-control" name="namatoko" value="<?php echo $data['namatoko']; ?>" >
                </div>
                <div class="form-group">
                    <label for="pwd">No. Telphone:</label>
                ...
                <div class="buttoninput">
                    <input class="btn btn-primary" type="submit" name="submit" value="Simpan"role="button"></input>
                    <a class="btn btn-danger" href="../menusuppliers.php" role="button">Batal</a>
                </div>
            </form>
            <br><br>
        </div>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-left">
							<p class="mb-0">
								<a href="index.html" class="text-muted"><strong>Dashboard Inventory App </strong></a> &copy
							</p>
						</div>
