...
if (isset($_GET['id'])) {
    ...
    if (!count($data)) {
        echo "<script>alert('Data tidak ditemukan pada database');window.location='editkeuangan.php';</script>";
    }
} else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id.');window.location='editkaryawan.php';</script>";
}
?>
                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <div class="inputdata">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Edit Data Keuangan</h1>

                        </div>
                        <form action="../proses/proseseditkeuangan.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="debit" value="<?php echo $data['debit']; ?>">
                            </div>

                            <div class="form-group">
                                <label for="pwd">Kredit - :</label>
                                <input type="text" class="form-control" name="kredit" value="<?php echo $data['kredit']; ?>">
                            </div>

                            <div class="form-group">
                                <label for="pwd">Saldo :</label>
                                <input type="text" class="form-control" name="saldo" value="<?php echo $data['saldo']; ?>">
                            </div>
