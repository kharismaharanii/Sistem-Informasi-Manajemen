...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM persediaanbarang WHERE id='$id'";
    ...
    if (!count($data)) {
        echo "<script>alert('Data tidak ditemukan pada database');window.location='editpersediaan.php';</script>";
    }
} else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id.');window.location='editpersediaan.php';</script>";
}
?>
                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <div class="inputdata">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Edit Data Persediaan Barang</h1>

                        </div>
                        <form action="../proses/proseseditpersediaan.php" method="POST" enctype="multipart/form-data">
                            <input name="id" value="<?php echo $data['id']; ?>" hidden />
                            <div class="form-group">
                                <label for="usr">Kode Barang :</label>
                                <input type="text" class="form-control" name="kodebarang" value="<?php echo $data['kodebarang']; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="usr">Tersedia :</label>
                                <input type="text" class="form-control" name="jumlahbarang" value="<?php echo $data['jumlahbarang']; ?>">
                            </div>

                            <div class="form-group">
                                <label for="pwd">Harga Satuan :</label>
                                <input type="text" class="form-control" name="hargasatuan" value="<?php echo $data['hargasatuan']; ?>">
                            </div>
