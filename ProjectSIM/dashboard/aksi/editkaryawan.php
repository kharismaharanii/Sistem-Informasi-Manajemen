...
if (isset($_GET['id'])) {
    ...
    if (!count($data)) {
        echo "<script>alert('Data tidak ditemukan pada database');window.location='editkaryawan.php';</script>";
    }
} else {
            ...
            <div id="content">
                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <div class="inputdata">
                        ...
                        <form action="../proses/proseseditkaryawan.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="buttoninput">
                                ...
                                <a class="btn btn-danger" href="../menukaryawan.php" role="button">Batal</a>
                            </div>
                        </form>
                        <br><br>
                    </div>
