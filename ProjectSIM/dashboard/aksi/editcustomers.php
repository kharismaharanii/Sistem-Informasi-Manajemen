   ...
   <div class="overlay"></div>
       ...
       <div class="container-fluid p-0 px-lg-0 px-md-0">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <form action="../proses/proseseditcustomers.php" method="POST" enctype="multipart/form-data" >
            <input name="id" value="<?php echo $data['id']; ?>" hidden />
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      <select class="custom-select" id="inputGroupSelect01" name="jeniskelamin" >
                        <option selected> <?php echo $data['jeniskelamin']; ?></option>
                ...
                <div class="buttoninput">
                    ...
                    <a class="btn btn-danger" href="menucustomers.php" role="button">Batal</a>
                </div>
            </form>
            <br><br>
        </div>
