...
if ($_SESSION['hakakses'] != "user") {
    ...
    if (!$result) {
        ...
        if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='editadmin.php';</script>";
              }
            } else {
                 echo "<script>alert('Masukkan data id.');window.location='editadmin.php';</script>";
                }
?>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <input name="id" value="<?php echo $data['id']; ?>" hidden />
                ...
                <div class="form-group">
                    ...
                    <center><a>NB : Untuk Hak Akses Inputkan (user)</a></center>
                </div>
                <div class="buttoninput">
                    <input class="btn btn-primary" type="submit" name="submit" value="Simpan"role="button"></input>
                    <a class="btn btn-danger" href="../menuadmin.php" role="button">Batal</a>
                </div>
            </form>
            <br><br>
        </div>
