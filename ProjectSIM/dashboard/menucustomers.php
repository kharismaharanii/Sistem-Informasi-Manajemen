          ...
          <div class="container-fluid px-lg-4">
            <div class="row">
              ...
              <div class="content read">
                <a href="aksi/tambahcustomer.php" class="create-contact">Tambah Customer</a>
                <table>
                  <thead>
                    <tr>
                      <td>No</td>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="actions">
                          <a href="aksi/editcustomers.php?id=<?php echo $row['id']; ?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                          <a href="proses/proseshapuscustomers.php?id=<?php echo $row['id']; ?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                        </td>
                      </tr>
                    <?php
                      $no++;
