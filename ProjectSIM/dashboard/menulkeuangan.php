                    ...
                    <div class="container-fluid px-lg-4">
                        <div class="row">
                            ...
                            <div class="content read">
                                <a href="aksi/tambahkeuangan.php" class="create-contact">Tambah Data</a>
                                <table>
                                    <thead>
                                        <tr>
                                            <td>No</td>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    <a href="aksi/editkeuangan.php?id=<?php echo $row['id']; ?>" class="edit" style="float: left;"><i class="fas fa-pen fa-xs"></i></a>
                                                    <a href="proses/proseshapuskeuangan.php?id=<?php echo $row['id']; ?>" class="trash" style="float: left;"><i class="fas fa-trash fa-xs"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
