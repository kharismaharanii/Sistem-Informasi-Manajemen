    ...
    <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
      <div class="simplebar-content" style="padding: 0px;">
        <a class="sidebar-brand" href="dashboard.php">
          <span class="align-middle"><i class="fa fa-shopping-cart" style="font-size:24px"></i> Inventory App</span>
        </a>
          ...
          <div class="container-fluid px-lg-4">
            <div class="row">
              ...
              <div class="content read">
                <a href="aksi/tambahsuppliers.php" class="create-contact">Tambah Suppliers</a>
                <table>
                  <thead>
                    <tr>
                      <td>No</td>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="actions">
                          <a href="aksi/editsuppliers.php?id=<?php echo $row['id']; ?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                          <a href="proses/proseshapussuppliers.php?id=<?php echo $row['id']; ?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                        </td>
                      </tr>
                    <?php
                      $no++;
