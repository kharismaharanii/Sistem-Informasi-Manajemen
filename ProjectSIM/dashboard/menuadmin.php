            ...
            <div class="container"><br>
              <div class="col-md-12 mt-lg-4 mt-4">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  ...
                  <a href="aksi/tambahadmin.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">+ Tambah Data</a>
                </div>
              </div>
              <table class="table">
                <thead>
                      ...
                      <td>
                        <div class="user-info">
                          <div class="user-info__img">
                            <img src="../img/logo.PNG" alt="User Img">
                          </div>
                      ...
                      <td>
                        <div class="dropdown open">
                          ...
                          <div class="dropdown-menu" aria-labelledby="triggerId1">
                            <a class="dropdown-item" href="aksi/editadmin.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil mr-1"></i> Edit</a>
                            <a class="dropdown-item text-danger" href="proses/proseshapusadmin.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash mr-1"></i> Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
